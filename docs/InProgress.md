...
Статус: 🟡 spec-review пройден; quality-review выявил блокирующие проблемы, исправления в работе. Четыре новых регрессионных теста ожидаемо падают до реализации исправлений.
...
- [ ] Добавить оставшиеся регрессионные тесты конкурентных действий и hydration.
- [ ] Реализовать исправления до прохождения всех регрессионных тестов.
