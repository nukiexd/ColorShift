...
| 4. Сессия, сохранение, прогресс | ✅ Завершён | ee99a5f |
| 5. Дизайн-система и главный экран | ⏳ Не начат | — |
| 6. Игровое поле, жесты, анимации | ⏳ Не начат | — |
...
Статус: ✅ завершён. Состояние сессии, persistence и provider concurrency проверены свежими spec-review и quality-review. Все 205 тестов, typecheck, lint и Expo Doctor проходят.
...
- [x] Получить 205 проходящих тестов, чистые typecheck и lint.
- [x] Пройти review соответствия спецификации.
...
- [x] Добавить causal session revision и epoch для stale settlement, pause/resume и competing siblings.
- [x] Проверять settlement повторным детерминированным вычислением полного перехода.
- [x] Повторно пройти spec-review на финальном коде.
- [x] Повторно пройти review качества без открытых Critical, Important и Minor замечаний.
- [x] Обновить этот раздел до статуса «Завершён».
- [x] Запушить проверенный результат.

## 5. Дизайн-система и главный экран

- [ ] Сгенерировать и сохранить дизайн-систему Color Shift.
- [ ] Утвердить финальные semantic tokens цветов, отступов, радиусов и теней.
- [ ] Подключить Manrope до скрытия splash screen.
- [ ] Настроить корневой layout, safe area и status bar.
- [ ] Создать PrimaryButton и PlayerCard.
- [ ] Создать главный экран с названием, уровнем, никнеймом и XP.
- [ ] Создать ModeSheet.
- [ ] Сделать Endless активным режимом.
- [ ] Показать Time Attack и Demining как заблокированные «Скоро».
- [ ] Создать ProfileSheet с редактированием никнейма.
- [ ] Показать неактивную заглушку аватара.
- [ ] Создать SettingsSheet с громкостью, вибрацией и reduced motion.
- [ ] Показывать «Продолжить» только при наличии активной партии.
- [ ] Добавить подтверждение замены сохранённой партии.
- [ ] Обеспечить touch targets не меньше 48×48 dp.
- [ ] Добавить semantic roles, labels и pressed states.
- [ ] Добавить и пройти тесты домашних сценариев.
...
- [ ] Создать AdaptiveBackground.
- [ ] Создать GameHud со счётом, рекордом, каскадом и паузой.
- [ ] Создать Tile с цветонезависимой меткой формы.
- [ ] Создать адаптивное поле Board 6×6.
- [ ] Ограничить размер блока максимумом 56×56 и радиусом 16.
- [ ] Уместить поле на экранах шириной от 360 px.
- [ ] Реализовать выбор блока одиночным тапом.
- [ ] Реализовать обмен вторым тапом по соседнему блоку.
- [ ] Реализовать reselection и снятие выбора.
- [ ] Реализовать gestureIntent с порогом включения 32%.
- [ ] Реализовать порог отмены preview 24%.
- [ ] Оставлять зажатый блок неподвижным до выбора направления.
- [ ] Анимировать preview обмена соседней пары.
- [ ] Ограничить один жест одним обменом.
- [ ] Откатывать неверный обмен.
- [ ] Блокировать ввод на время resolution.
- [ ] Анимировать swap, clear, gravity и refill по снимкам resolver.
- [ ] Плавно менять цветное свечение фона.
- [ ] Реализовать reduced-motion вариант.
- [ ] Добавить accessibility labels для цвета, координат и бонуса.
- [ ] Добавить и пройти тесты жестов и контроллера.
- [ ] Пройти review соответствия спецификации.
- [ ] Пройти review качества кода.
- [ ] Обновить InProgress и запушить результат.
