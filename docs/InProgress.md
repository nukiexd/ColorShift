...
Статус: 🟡 реализация закоммичена; review-gates ещё не пройдены.
...
- [ ] Исправить все замечания spec-review и повторно пройти проверку.
- [ ] Пройти review качества кода.
- [ ] Исправить все замечания quality-review и повторно пройти проверку.
